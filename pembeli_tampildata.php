    ...
    <nav class="navbar navbar-dark py-3">
        ...
        <div class="justify-content-right">
                <ul class="nav fw-bold px-5">
                    <li class="nav-item">
                        <a href="pembeli_tampildata.php" class="btn btn-outline-light px-3 mx-3 pb-0 rounded-pill active">
                            <h4 class="card-title text-center align-items-center">Pembeli</h4>
                        </a>
                    </li>
                        <a href="pesanan_tampildata.php" class="btn btn-outline-light px-3 pb-0 rounded-pill">
